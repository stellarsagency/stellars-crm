...
async function start() {
  ...
  app.post('/api/leads/bulk', (req, res) => {
    ...
    for (const l of leads) {
      run(`INSERT INTO leads (business_name,owner_name,phone,email,website,city,state,niche,rating,reviews,status,source)
        VALUES (?,?,?,?,?,?,?,?,?,?,?,?)`,
        [l.business_name, l.owner_name||null, l.phone||null, l.email||null, l.website||null, l.city||null, l.state||null, l.niche||null,
         l.rating||null, l.reviews||null, 'new', l.source||'scraper']);
      count++;
    }
    res.json({ message: `${count} leads imported` });
  });
